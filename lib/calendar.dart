...
class CalendarChoose extends StatefulWidget {
  ...
  Color innerRangeBackgroundColor = Colors.deepPurple[200];
  Color selectionBackgroundColor = Colors.purple;
...
//  CalendarChoose({this.type});
  CalendarChoose(this.type,
      ...
      this.selectionBackgroundColor = Colors.deepPurple,
      this.selectionFontColor = Colors.white});

  CalendarChoose.range(
      {this.currentDateBackgroundColor = Colors.redAccent,
      this.currentDateFontColor,
      this.rangeStartEndBackgroundColor = Colors.deepPurple,
      this.innerRangeBackgroundColor = Colors.indigoAccent}) {
...
class CalendarChooseState extends State<CalendarChoose>
  ...
  List weeks = ["Вс", "Пн", "Вт", "Ср", "Чт", "Пт", "Сб"];
  ...
  void initState() {
    ...
    } else if (widget.type == Calendar.EVENT) {
      rangeDate = false;
